...
public class LoginManager implements Login{
    ...
    public void loginActionPerformed() {
        try(Connection connection = DriverManager.getConnection(URL, "root", "RootPassword95")) {

            String query = "select * from man_users where username =? and password =?";
    ...
    private void correctPasswordManager(){}
}
